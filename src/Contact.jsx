...
<div class="mb-3">
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" name="msg" value={data.msg} onChange={InputEvent} placeholder="What's on your mind?" rows="3"></textarea>
</div>
<div class="col-12">
